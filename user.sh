...
VALIDATE $? "dowloading user artifact"
...
VALIDATE $? "unzipping user folder"
...
cp /home/devops/daws-74s/repos/roboshop-shell/user.service /etc/systemd/system/user.service &>>$LOGFILE
